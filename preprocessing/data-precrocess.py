...
class DataPreprocessing:
    ...
    def split(self, test_percent, validation_percent=0.1, rs=42):
        self.train_features, self.test_features, self.train_target, self.test_target = \
            self.objects['train test split'](self.input, self.output, test_size=test_percent, random_state=rs)

        self.test_features, self.val_features, self.test_target, self.val_target = \
            self.objects['train test split'](self.test_features, self.test_target, test_size=validation_percent, random_state=rs)
